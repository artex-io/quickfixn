...
public class QuoteStatusReport : Message
{
    ...
    public void Set(BidQuoteID val) { BidQuoteID = val; }
    public BidQuoteID Get(BidQuoteID val) { GetField(val); return val; }
    public bool IsSet(BidQuoteID val) { return IsSetBidQuoteID(); }
    public bool IsSetBidQuoteID() { return IsSetField(Tags.BidQuoteID); }

    public OfferQuoteID OfferQuoteID
    {
        get
        {
            OfferQuoteID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(OfferQuoteID val) { OfferQuoteID = val; }
    public OfferQuoteID Get(OfferQuoteID val) { GetField(val); return val; }
    public bool IsSet(OfferQuoteID val) { return IsSetOfferQuoteID(); }
    public bool IsSetOfferQuoteID() { return IsSetField(Tags.OfferQuoteID); }

    public BidMDEntryID BidMDEntryID
    {
        get
        {
            BidMDEntryID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(BidMDEntryID val) { BidMDEntryID = val; }
    public BidMDEntryID Get(BidMDEntryID val) { GetField(val); return val; }
    public bool IsSet(BidMDEntryID val) { return IsSetBidMDEntryID(); }
    public bool IsSetBidMDEntryID() { return IsSetField(Tags.BidMDEntryID); }

    public OfferMDEntryID OfferMDEntryID
    {
        get
        {
            OfferMDEntryID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(OfferMDEntryID val) { OfferMDEntryID = val; }
    public OfferMDEntryID Get(OfferMDEntryID val) { GetField(val); return val; }
    public bool IsSet(OfferMDEntryID val) { return IsSetOfferMDEntryID(); }
    public bool IsSetOfferMDEntryID() { return IsSetField(Tags.OfferMDEntryID); }
